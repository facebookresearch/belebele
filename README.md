...
View the dataset on 🤗 [Hugging Face](https://huggingface.co/datasets/facebook/belebele). ![number of datasets](https://img.shields.io/endpoint?url=https://huggingface.co/api/shields/datasets&color=brightgreen)
